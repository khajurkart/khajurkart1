...
const ActionCard = ({ to, icon: Icon, title, description, variant = 'primary' }) => {
    const styles = {
        ...
        outline: 'bg-khajur-cream border-2 border-khajur-primary text-khajur-primary hover:bg-khajur-primary hover:text-khajur-cream',
        white: 'bg-white border border-khajur-border text-khajur-primary hover:shadow-md hover:border-khajur-gold',
...
const LowStockBanner = ({ count }) => (
    <div className="flex items-center gap-3 bg-red-50 border border-red-200 text-red-700 px-5 py-4 mb-8 rounded-sm">
        ...
        <p className="text-sm font-medium">
            ...
            are running low on stock. Please restock soon.
        </p>
        <Link
            to="/admin/products"
...
const TabBar = ({ active, onChange }) => (
    <div className="flex items-center gap-1 border-b border-khajur-border mb-10">
        {TABS.map(({ id, label, icon: Icon }) => (
            <button
                ...
                className={`
                    ...
                    ${active === id
                        ? 'border-khajur-gold text-khajur-gold'
                        : 'border-transparent text-khajur-dark/50 hover:text-khajur-primary'
                    }
                `}
            >
...
const AdminDashboard = () => {
    ...
    const statCards = [
        ...
        { icon: TrendingUp, value: `₹${stats.totalRevenue.toFixed(2)}`, label: 'Total Revenue', highlight: true },
    ];
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12">
                ...
                {activeTab === 'overview' && (
                    <>
                        ...
                        {/* Coupon shortcut card */}
                        <section className="mt-4">
                            <button
                                onClick={() => setActiveTab('coupons')}
                                className="
                                    group w-full flex items-center gap-4 p-8
                            ...
                            >
                                ...
                                <div className="flex-1 text-left">
                                    ...
                                    <p className="text-sm text-teal-100 leading-relaxed">
                                        Create & manage discount coupons and welcome offers.
                                    </p>
                                </div>
