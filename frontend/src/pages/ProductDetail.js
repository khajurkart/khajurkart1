...
const ProductDetail = () => {
    const { id } = useParams();
    const [product, setProduct] = useState(null);import React, { useState, useEffect } from 'react';
import { useLocation } from "react-router-dom";
import { useParams, Link } from 'react-router-dom';
import axios from 'axios';
import { ShoppingCart, Heart, ChevronLeft } from 'lucide-react';
                ...
                <div className="mt-16 max-w-5xl mx-auto">
                    ...
                    <div className="text-center">
                        {activeTab === "description" && (
                            <div
                                className="text-left text-khajur-dark/80 leading-8 space-y-4 [&_b]:font-bold [&_h3]:font-bold [&_h3]:text-xl"
