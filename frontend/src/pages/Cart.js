...
const Cart = () => {
    ...
    // ✅ handleQuantityChange is now clean - only does one thing
    ...
    // ✅ empty cart check moved outside
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-khajur-muted mb-1">{item.size && `Size: ${item.size}`}</p>
                                    ...
                                    <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-start gap-4">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <span className="text-lg font-medium w-8 text-center" data-testid={`cart-item-quantity-${item.product_id}`}>
                                                {item.quantity}
                                            </span>
                                            <button
                                                onClick={() => handleQuantityChange(item.product_id, item.quantity + 1)}
