...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white" data-testid="home-page">
      ...
      {/* ── Categories Grid ──────────────────────────────────────────────────── */}
      <section className="py-20 md:py-32 bg-white" data-testid="categories-section">
      ...
      {/* ── Bulk Orders Banner ────────────────────────────────────────────────── */}
      <section className="py-20 bg-khajur-primary">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
      ...
      {/* ── Final CTA Banner ──────────────────────────────────────────────────── */}
      <section className="py-20 bg-khajur-cream border-t border-khajur-border">
