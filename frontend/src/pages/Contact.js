        ...
        details: (
            <div className="flex flex-col gap-1.5">
                <a
                    ...
                    className="hover:text-khajur-gold transition-colors duration-200"
                >
                    +91 91331 05000
                </a>
...
const Field = ({ label, required, children, htmlFor }) => (
    <div className="space-y-2">
        ...
        >
            ...
            {required && (
                <span className="text-khajur-gold ml-1">*</span>
            )}
        </label>
    ...
    >
        ...
        <div className="flex-1 min-w-0">
            ...
            {link ? (
                ...
                <div className="text-sm font-medium text-khajur-primary leading-relaxed">
                    {details}
                </div>
    ...
    <div className="flex flex-col gap-8">
        ...
        <div className="border-t border-khajur-border pt-5">
            ...
            <p className="text-xs text-khajur-dark/40 leading-relaxed">
                For bulk orders or wholesale inquiries, please reach out
                via email or WhatsApp for a custom quote.
            </p>
        ...
        >
            ...
            <section className="bg-khajur-primary py-14">
                ...
                >
                    ...
                    {/* Two WhatsApp Bulk Quote Buttons */}
