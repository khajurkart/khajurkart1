...
const AdminOrders = () => {
    ...
    // ✅ Added silent flag to avoid showing full-page spinner on background reloads
    ...
    const updateOrderStatus = async (orderId, status) => {
        try {
            ...
            // ✅ Silent reload — fetches fresh data from server without showing spinner
            await fetchOrders(true);

            // ✅ Sync the selected order in the modal if it's currently open
    ...
    const deleteOrder = async (id) => {
        ...
        try {
            ...
            // ✅ Silent reload after delete as well
            await fetchOrders(true);
